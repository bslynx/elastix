...
<tr>
  <td>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
      <tr>
	<td width="35%"><INPUT type="checkbox" name="restore_total" id="restore_total" onClick=ChequearTodos(this); {$all_checked}><b>{$LBL_TODOS}</b></td>
      </tr>
  ...
  {/foreach}
        ...
        <td><b>{$LBL_BACKUP_FILE}:&nbsp;</b><input type='text' name='backup_file'></td>
        </tr>
     </table>
    </td>
</tr>
