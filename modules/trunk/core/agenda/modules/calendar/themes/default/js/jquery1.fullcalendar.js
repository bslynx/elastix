...
$.fn.fullCalendar = function(options) {
	...
	this.each(function() {
		...
		function render(inc, forceUpdateSize) { //alert(inc + "," + forceUpdateSize);
		...
		if (sections) {
            ...
            /*if(addImage == true){
                $('.fc-header-left tr').append("<td><div class='fc-button-add ui-state-default  ui-corner-left ui-corner-right'><a id='add_news' style='cursor: pointer;'><image src='/modules/"+module+"/images/Add.png' width='21' height='21'  onclick='displayNewEvent(event);' style='border:none;' alt='Add' /></a></div></td>");
            }*/
            $('.fc-header-left tr').append("<td><span class='fc-header-space'></span></td>");
            //*******************************************************************************
		}
...
views.month = function(element, options) { /*alert(element[0].className);*/
