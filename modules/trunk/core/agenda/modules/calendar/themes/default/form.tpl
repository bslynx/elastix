...
<link rel="stylesheet" type="text/css" href="modules/{$module_name}/themes/css/fullcalendar.css" />
<script type="text/javascript" src ="modules/{$module_name}/themes/js/javascript.js"></script>
<script type="text/javascript" src ="modules/{$module_name}/themes/js/calendar.js"></script>
