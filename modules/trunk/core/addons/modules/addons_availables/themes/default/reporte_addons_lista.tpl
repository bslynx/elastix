{foreach from=$arrData key=k item=data}
  <div class="neo-addons-row">
	...
	{/if}
        {/if}
{* Cuando se determine quiénes son trial:
<div class="neo-addons-row-button-trial-left">TRIAL</div>
<div class="neo-addons-row-button-trial-right"><img src="modules/{$module_name}/images/addons_icon_install.png" width="17" height="17" alt="Install" /></div>
*} 
    </div>
    <div class="neo-addons-row-moreinfo">More info...</div>
  </div>
{/foreach}
