<table cellspacing="0" cellpadding="0" border="0" width="100%">
  <tr>
    ...
    <li><a href="/?menu=pbxconfig&amp;display=zapchandids"  >{$Zap_Channel_DIDs}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=announcement"  >{$Announcements}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=blacklist"  >{$Blacklist}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=cidlookup"  >{$CallerID_Lookup_Sources}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=daynight"  >{$Day_Night_Control}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=findmefollow"  >{$Follow_Me}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=ivr"  >{$IVR}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=queueprio"  >{$Queue_Priorities}</a></li>
    ...
    <li><a href="/?menu=pbxconfig&amp;display=languages"  >{$Languages}</a></li>
    ...
    <li><a href="/?menu=pbxconfig&amp;display=vmblast"  >{$VoiceMail_Blasting}</a></li>
    <li>{$Remote_Access}</li>
    <li><a href="/?menu=pbxconfig&amp;display=callback"  >{$Callback}</a></li>
    <li><a href="/?menu=pbxconfig&amp;display=disa"  >{$DISA}</a></li>
    <li>{$Option}</li>
    <li><a href="/admin/"  class="info" target="_blank">{$Unembedded_freePBX} <span style='margin-left:2.7cm'>{$INFO}</span></a></li>
</ul></div></td>
