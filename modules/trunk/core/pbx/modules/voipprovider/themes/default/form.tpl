<link   rel ="stylesheet"      href="/modules/voipprovidercust/themes/style.css" />
<script type="text/javascript" src="/modules/voipprovidercust/themes/js/javascript.js"></script>
<script type="text/javascript" src="/modules/voipprovidercust/themes/js/validaciones.js"></script>
...
<div class="tabForm" style="font-size: 16px; height: 400px" width="100%">
    ...
    <label id="title" >General Setting</label>
    <table border="0" width="90%" cellspacing="0" cellpadding="8" style="border:1px solid black">
    <tr class="letra12">
    ...
    <div id="detail">
        ...
        <label id="title">PEER Details</label>

        <table border="0" width="60%" id="formContainer" align="center" cellspacing="0" cellpadding="8" style="border:1px solid black">
