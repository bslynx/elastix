        ...
        <table class="tabForm" style="font-size: 16px;" width="100%" >
            ...
            <tr class="letra12">
                ...
                <td align="left"><select id='nat' name='nat'>
                    {html_options options=$selec_nat }
                </select></td>
            </tr>
            <tr class="letra12">
                <td align="left" width="50%"><b>{$type.LABEL}: </b></td>
                <td align="left"><select id='nat' name='nat'>
                    {html_options options=$selec_type }
                </select></td>
            </tr>
            <tr class="letra12">
                <td align="left" width="50%"><b>{$accountcode.LABEL}: <span  class="required">*</span></b></td>
                <td align="left">{$accountcode.INPUT}</td>
            </tr>
            <tr class="letra12">
                <td align="left" width="50%"><b>{$amaflags.LABEL}: </b></td>
                <td align="left"><select id='nat' name='nat'>
                    {html_options options=$selec_amaflags }
                </select></td>
            </tr>
            <tr class="letra12">
                <td align="left" width="50%"><b>{$call_limit.LABEL}: <span  class="required">*</span></b></td>
                <td align="left">{$call_limit.INPUT}</td>
            </tr>
            <tr class="letra12">
                <td align="left" width="50%"><b>{$call_group.LABEL}: <span  class="required">*</span></b></td>
            ...
            <!--<tr class="letra12">
                ...
                <td align="left">{$can_call_forward.INPUT}</td>
            </tr>-->
            <tr class="letra12">
                <td align="left" width="50%"><b>{$can_reinvite.LABEL}: </b></td>
                <td align="left">{$can_reinvite.INPUT}</td>
            </tr>
            <tr class="letra12">
            ...
            <tr class="letra12">
                ...
                <td align="left">{$allow.INPUT}</td>
            </tr>
            <tr class="letra12">
                <td align="left" width="50%"><b>{$reg_second.LABEL}: </b></td>
                <td align="left">{$reg_second.INPUT}</td>
            </tr>
            -->
    </table>
</fieldset>
    ...
    <table class="tabForm" style="font-size: 16px;" width="100%" >
        ...
        <tr class="letra12">
            ...
            <td align="left" ><select id='dtmfmode' name='dtmfmode'>
                    {html_options options=$selec_dtmfmode }
                </select> </td>
        </tr>
    </table>
</fieldset>
...
<legend id="sombreado">Recording Options</legend>
    <table class="tabForm" style="font-size: 16px;" width="100%" >
        <tr class="letra12">
            <td align="left" width="50%"><b>{$incoming.LABEL}: <span class="required">*</span></b></td>
            <td align="left" ><select id='incoming' name='incoming'>
                    {html_options options=$selec_recording }
            </select> </td>
        </tr>
        <tr class="letra12">
            <td align="left" width="50%"><b>{$outgoing.LABEL}: <span class="required">*</span></b></td>
...
<legend id="sombreado">Voicemail & Directory</legend>
    <table class="tabForm" style="font-size: 16px;" width="100%" >
        <tr class="letra12">
            <td align="left" width="50%"><b>{$status.LABEL}: <span class="required">*</span></b></td>
            <td align="left" ><select id='incoming' name='incoming'>
                    {html_options options=$selec_status }
            </select> </td>
        </tr>
        <tr class="letra12">
            <td align="left" width="50%"><b>{$voicemailpassword.LABEL}: <span class="required">*</span></b></td>
            <td align="left" >{$voicemailpassword.INPUT}</td>
        </tr>
        <tr class="letra12">
            <td align="left" width="50%"><b>{$emailaddress.LABEL}: <span class="required">*</span></b></td>
