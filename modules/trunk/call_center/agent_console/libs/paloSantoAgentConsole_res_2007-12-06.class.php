...
function save_log_prueba($texto){
    ...
    /*
    insert into audit 
    (id_agent,datetime_init) 
    values (5,'2007-12-06 10-30:15');
    
    update audit
    set datetime_end='2007-12-06 10:34:00' , duration=timediff('2007-12-06 10:34:00',datetime_init) 
    where id =121 ;
    */
