  ...
  <td>
    <table width="100%" cellpadding="4" cellspacing="0" border="0">
      <tr class="letra12">
        ...
        <td width="12%" align="left">{$filter_field.LABEL}:<span  class="required">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$filter_field.INPUT}&nbsp;&nbsp;{$filter_value.INPUT}</td>
     ...
     <tr class="letra12">
        ...
        <td width="12%" align="left">{$filter_pattern.LABEL}: <span  class="required">*</span>&nbsp;{$filter_pattern.INPUT}</td>


        <td width="10%" align="center"><input class="button" type="submit" name="submit" value="{$Filter}" ></td>
      </tr>
