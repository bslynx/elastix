          ...
          <tr>
            ...
            <td class="headlinkon" valign="bottom">
              <table cellSpacing="0" cellPadding="2" height="30" border="0">
                <tr><td class="menutabletabon_left" nowrap valign="top"><IMG src="themes/giox/images/1x1.gif"></td><td class="menutabletabon" title="" nowrap><a
                        class="menutableon" href="/?menu={$idMenu}">{$menu.Name}</a></td><td class="menutabletabon_right" nowrap valign="top"><IMG src="themes/giox/images/1x1.gif"></td>
                </tr>
              </table>
            </td>
            {else}
            <td class="headlink" valign="bottom">
              <div style="position:absolute; z-index:200; top:65px;"><a href="javascript:mostrar_Menu('{$idMenu}')"><img src="themes/giox/images/corner.gif" border="0"></a></div>
              ...
              <table cellSpacing="0" cellPadding="2" height="29" border="0">
                <tr><td class="menutabletaboff_left" nowrap valign="top"><IMG src="themes/giox/images/1x1.gif"></td><td class="menutabletaboff" title="" nowrap><a
                        class="menutable" href="/?menu={$idMenu}">{$menu.Name}</a></td><td class="menutabletaboff_right" nowrap valign="top"><IMG src="themes/giox/images/1x1.gif"></td>
                </tr>
              </table> 
            </td>
            {/if}
        ...
        <table cellspacing="0" cellpadding="2" width="100%">
          <tr>
            ...
            <td align="right" valign="middle"><a href="javascript:openWindow('/help/?id_nodo={$idSubMenuSelected}&name_nodo={$nameSubMenuSelected}')"><img
                src="themes/giox/images/help_top.gif" border="0"></a>&nbsp;&nbsp;<a href="javascript:changeMenu()"><img
                src="themes/giox/images/arrow_top.gif" border="0"></a>&nbsp;&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
    <tr class="downshadow"><td><img src="themes/giox/images/1x1.gif" height="5"></td></tr>
  </table>
</div>
  ...
  <table cellspacing="0" cellpadding="0" width="100%" class="menumini">
    <tr>
      ...
      <td align="right" class="letra_gris" valign="middle">{$nameMainMenuSelected} &rarr; {$nameSubMenuSelected} {if !empty($idSubMenu2Selected)} &rarr; {$nameSubMenu2Selected} {/if}
          &nbsp;&nbsp;<a href="javascript:openWindow('/help/?id_nodo={$idSubMenuSelected}&name_nodo={$nameSubMenuSelected}')"><img src="themes/giox/images/help_bottom.gif" border="0" 
          align="absmiddle"></a>
          &nbsp;&nbsp;<a href="javascript:changeMenu()"><img src="themes/giox/images/arrow_bottom.gif" border="0" align="absmiddle"></a>&nbsp;&nbsp;
      </td>
    </tr>
  </table>
</div>
